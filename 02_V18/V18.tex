...
die Compton Streuung und die Elektronenpaarbildung.
...
Die Interaktionswahrscheinlichkeit von Gamma Strahlen mit Materie lässt sich durch den 
Dämpfungskoeffizienten $\mu$ darstellen.
Die Strahlungsintensität fällt in dichten Materialien exponentiell ab.
...
\subsection{Messung von Energie in Germanium Halbleiterdetektoren \cite{book:gilmore}}
