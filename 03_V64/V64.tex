...
\begin{figure}[H]
	...
	\caption{Polarization Typs of Light: In red the electric field component and in black the projektion on to the plane \cite{book:skript}}\label{fig:po}
\end{figure}
...
To estimate the refractive index of glass in the experiment two rotatable glass planes, 
which each is tilted by $\theta_0=10°$ to each other, get inserted in the light beam. 
By rotating the glass planes they change together by an angle $\theta$ to the direction of propagation, around an axis perpendicular to the ground. 
