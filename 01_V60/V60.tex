...
Wenn nun ein Strom durch diese Grenzschicht fließt entstehen Elektronen Lochpaare, welche in dieser Aktienschicht % was ist das? @BENE
...
\begin{description}
    ...
    \item[2.Die innere Cavity] oder auch optischer Hohlraumresonator sorgt für das sich ganzzahlige vielfache der Wellenlänge bilden, % Das ist nicht präzise @BENE
    die stehende Wellen im Chip erzeugen. 
    ...
    \item[4.Die äußere Cavity] ist deutlich größer als die innere mit $\Delta_{FSR} \approx  \qty{10}{\giga\hertz}$ und kann durch einen piezo-elektrischen Aktuator verändert werden. 
\end{description}
