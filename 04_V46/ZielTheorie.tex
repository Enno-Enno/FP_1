...
% Bei direkten Halbleiter liegt das Minimum des Leitungsbandes und das Maximum 
% des Valenzbandes übereinander (siehe Abbildung \ref{fig:band}).
...
% Dieses liegt an einem Versatz zwischen den Minima und Maxima der jeweiligen
% Bänder, sodass ein direkter Übergang nicht möglich ist. 
