...
\section{Theorie}
In diesem Versuch scheint eine linear polarisierte elektromagnetische Welle durch
...
$\qtyrange{1}{3}{\eV}$\cite{web:Bandlücke}. Die Bandstruktur von Halbleitern ist auch
...
Funktion angenähert werden (siehe Abbildung \ref{fig:band}). Elektronen können
zum Beispiel thermisch oder optisch angeregt werden, um vom Valenzband ins
Leitungsband zu wechseln. Dazu müssen sie sowohl die nötige Energie als auch je
nach Bandstruktur einen gewissen Impuls aufnehmen.
