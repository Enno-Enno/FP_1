...
\begin{align}
	\lambda&=\qty{0.607(0.019)}{\per\us} &\Rightarrow & & \tau&=\frac{1}{\lambda }=\qty{1.65(0.05)}{\us} \\
	N_0&=\num{186(8)} \notag \\
	U&=\num{1.83(0.26)} \notag
\end{align}
...
\begin{align}
	m&=\qty{-0.423(0.014)}{\per\us} &\Rightarrow & & \tau&=\frac{1}{|m|}=\qty{2.37(0.08)}{\us} \\
	b&=\num{4.51(0.11)} &\Rightarrow & & N_0&=\num{91(10)} \notag
\end{align}

\subsubsection{Keine Ahnung wie ich das nennen aber kein Bock mehr auf die Scheiße}
