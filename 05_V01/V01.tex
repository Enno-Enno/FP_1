...
%	\caption{Myonenlebensdauer im blau und cyan Bereich mit Ausgleichsgerade durch die logarithmischen Daten; ($y-Skale: log$)}\label{fig:plt6a}
%\end{figure}
%
%\begin{figure}[H]
%	\centering
...
%die Ergebnisse gerade für den Exponentialfit noch ungenauer. 
