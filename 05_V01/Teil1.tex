...
$\tau = (2.1969811 \pm0.0000022)\cdot 10^{-6}\unit{\s}   $\cite{Workman:2022ynf}.
...
% Standardmodell
% Lebensdauer DONE 
% Reichweite klassisch und relativistisch (E_\mu = \qty{10}{\GeV}) DONE

\subsection{Messung von Szintillations-Leuchten mit Photodetektoren \cite{book:kolano}}
...
Der Szintillator Tank mit den zwei PMT ist über zwei Verzögerungsleitungnen
...
Photodetektoren in der Lage ist das Stoppsignal im TAS zu aktivieren.
Sowohl Start- als auch Stoppsignale werden mit einem Counter gezählt. 


%% Monoflop Zeug Signal verstehen