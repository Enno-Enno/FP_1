...
plt.bar(t_myon[0:A],N_myon[0:A],color="r",width=m,label="ungenutzte Werte")
...
plt.figure(constrained_layout=True)
plt.bar(t_myon[A:B],N_myon[A:B],color="c",width=m,label="Messwerte")#,yerr=np.sqrt(N_myon[A:B])
plt.plot(t,exp(t,lamda,N,U),"r-",label="Exponitialfit")
plt.xlabel(r"$t \, [\mathrm{\mu s}]$")
plt.ylabel(r"$N$")
plt.xlim(A*m+b,B*m+b)
plt.grid()
#plt.yscale("log")
plt.title("Exponentielle Ausgleichrechnung")
plt.legend()
plt.savefig("build/plot5b.pdf")
#plt.show()
...
#plt.yscale("log")
#plt.legend()
#plt.savefig("build/plot6a.pdf")
##plt.show()
#
#plt.figure(constrained_layout=True)
#plt.bar(t_myon[A:B],N_myon[A:B],color="c",width=m,label="Messwerte NACH der Kante")
#plt.bar(t_myon[C:A],N_myon[C:A],color="b",width=m,label="Korregierte Messwerte VOR der Kante")
#plt.plot(t,exp(t,lamda2,N2,U2),"r-",label="Exponitialfit")
#plt.xlabel(r"$t \, [\mathrm{\mu s}]$")
#plt.ylabel(r"$N$")
#plt.xlim(C*m+b,B*m+b)
#plt.yscale("log")
#plt.legend()
#plt.savefig("build/plot6b.pdf")
#plt.show()
